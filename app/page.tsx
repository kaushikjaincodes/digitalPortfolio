...
>
  ...
  <p className="mt-4 text-xl text-white mb-6 relative z-10">
  ...
  <a href="#projects">
    <button className="p-[3px] relative z-10">
      ...
      <section id="about" className="h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-20 gap-10">
      ...
      <section id="projects" className="h-screen flex flex-col md:flex-row-reverse items-center justify-center px-6 md:px-20 gap-10">
        <div className="md:w-1/2">
          <motion.h2 
            className="text-4xl font-bold text-white"
            initial={{ opacity: 0, y: 50 }}
      ...
      <section id="contact" className="h-screen flex flex-col md:flex-row items-center justify-center px-6 md:px-20 gap-10">
        <div className="md:w-1/2">
          <motion.h2 
            className="text-4xl font-bold text-white"
            initial={{ opacity: 0, y: 50 }}
          ...
          <p className="mt-4 text-gray-400 mb-7">
